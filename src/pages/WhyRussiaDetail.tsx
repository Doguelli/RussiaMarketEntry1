      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-16">
          ...
          >
            ...
            <h2 className="text-[32px] font-bold text-primary-500 mb-6">{t('home.why_russia_detail.volume_title')}</h2>
            <div className="prose prose-slate prose-lg max-w-none text-slate-600">
              <p dangerouslySetInnerHTML={{__html: t('home.why_russia_detail.volume_p1')}}></p>
              <p dangerouslySetInnerHTML={{__html: t('home.why_russia_detail.volume_p2')}}></p>
              <ul>
                <li>{t('home.why_russia_detail.volume_li1')}</li>
                <li>{t('home.why_russia_detail.volume_li2')}</li>
                <li>{t('home.why_russia_detail.volume_li3')}</li>
              </ul>
            </div>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-[32px] font-bold text-primary-500 mb-6">{t('home.why_russia_detail.demand_title')}</h2>
            <div className="prose prose-slate prose-lg max-w-none text-slate-600">
              <p dangerouslySetInnerHTML={{__html: t('home.why_russia_detail.demand_p1')}}></p>
              <p>{t('home.why_russia_detail.demand_p2')}</p>
              <ul>
                <li>{t('home.why_russia_detail.demand_li1')}</li>
                <li>{t('home.why_russia_detail.demand_li2')}</li>
                <li>{t('home.why_russia_detail.demand_li3')}</li>
              </ul>
            </div>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-[32px] font-bold text-primary-500 mb-6">{t('home.why_russia_detail.logistics_title')}</h2>
            <div className="prose prose-slate prose-lg max-w-none text-slate-600">
              <p dangerouslySetInnerHTML={{__html: t('home.why_russia_detail.logistics_p1')}}></p>
              <p dangerouslySetInnerHTML={{__html: t('home.why_russia_detail.logistics_p2')}}></p>
              <ul>
                <li>{t('home.why_russia_detail.logistics_li1')}</li>
                <li>{t('home.why_russia_detail.logistics_li2')}</li>
                <li>{t('home.why_russia_detail.logistics_li3')}</li>
              </ul>
            </div>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-[32px] font-bold text-primary-500 mb-6">{t('home.why_russia_detail.competition_title')}</h2>
            <div className="prose prose-slate prose-lg max-w-none text-slate-600">
              <p>{t('home.why_russia_detail.competition_p1')}</p>
              <p dangerouslySetInnerHTML={{__html: t('home.why_russia_detail.competition_p2')}}></p>
              <ul>
                <li>{t('home.why_russia_detail.competition_li1')}</li>
                <li>{t('home.why_russia_detail.competition_li2')}</li>
                <li>{t('home.why_russia_detail.competition_li3')}</li>
              </ul>
            </div>
          </motion.div>
        ...
        <div className="mt-16 bg-primary-500 rounded-3xl p-10 md:p-14 text-center">
           <h2 className="text-[32px] font-extrabold text-white mb-6">{t('home.why_russia_detail.cta_title')}</h2>
